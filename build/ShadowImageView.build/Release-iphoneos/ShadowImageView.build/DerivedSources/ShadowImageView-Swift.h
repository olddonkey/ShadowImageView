...
SWIFT_CLASS("_TtC15ShadowImageView11AppDelegate")
...
SWIFT_CLASS("_TtC15ShadowImageView15ShadowImageView")
...
/// \param from input image
///
///
/// returns:
/// the real size of the image
- (CGSize)getRealImageSize:(UIImage * _Nonnull)from SWIFT_WARN_UNUSED_RESULT;
...
@interface UIImage (SWIFT_EXTENSION(ShadowImageView))
@end

@class NSBundle;

SWIFT_CLASS("_TtC15ShadowImageView14ViewController")
